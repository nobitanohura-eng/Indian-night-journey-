  ...
  return (
    ...
    >
      <BusChassis>
        ...
        <div className="absolute bottom-[115px] sm:bottom-[130px] md:bottom-[140px] landscape:bottom-[52px] left-2 sm:left-6 md:left-[6%] z-30 pointer-events-auto flex items-end gap-2 sm:gap-3 scale-85 sm:scale-100 landscape:scale-75 origin-bottom-left">
          ...
          >
            <div className={`relative px-2.5 py-1.5 sm:px-3.5 sm:py-2.5 bg-[#1a1714]/95 backdrop-blur-xl border-[2px] border-[#3a2e22] flex flex-col items-center justify-center rounded-xl shadow-[0_10px_25px_rgba(0,0,0,0.8)] ${
              ...
              {/* Retro Box/Text */}
              <div className="border border-dashed border-[#ffb300]/50 px-2 sm:px-3 py-1 flex flex-col items-center">
                <span className={`font-mono text-[9px] sm:text-[10px] md:text-xs font-bold tracking-[0.18em] transition-colors duration-100 whitespace-nowrap ${
                  hornActive ? 'text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]' : 'text-[#ffb300]'
                }`}>
                  HORN OK PLEASE
                </span>
                <div className="flex items-center gap-1 mt-0.5">
                  <span className={`text-xs sm:text-sm transition-all duration-100 ${
          ...
          >
            ...
            <span className="text-[7.5px] sm:text-[8px] font-mono font-bold text-white/80 uppercase tracking-widest mt-0.5">
              DIPPER
            </span>
          </button>
          ...
          >
            <span className={`text-xs sm:text-sm ${hazardsActive ? 'text-red-400 animate-pulse' : 'text-white/40'}`}>
              ▲
            </span>
            <span className={`text-[7.5px] sm:text-[8px] font-mono font-bold uppercase tracking-widest mt-0.5 ${
